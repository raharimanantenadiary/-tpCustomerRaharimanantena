 ...
 */
package com.mycompany.tpcustomerraharimanantena.entity;
...
/**
 * Classe Entite représentant MicroMarket
 * @author Diary
 */
@Entity
...
public class MicroMarket implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.tpcustomerraharimanantena.entity.MicroMarket[ zipCode=" + zipCode + " ]";
    }
